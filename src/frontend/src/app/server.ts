...
export class TransactionPageClient {
    ...
    export(includeRaw: boolean | undefined, includeFinal: boolean | undefined, search: string | null | undefined, startDate: string | null | undefined, endDate: string | null | undefined): Observable<FileResponse> {
        ...
        else if (includeRaw !== undefined)
            url_ += "includeRaw=" + encodeURIComponent("" + includeRaw) + "&";
...
export class MailIntegrationClient {
    ...
    getSyncStatus(): Observable<EmailSyncStatusResponse> {
        let url_ = this.baseUrl + "/api/MailIntegration/GetSyncStatus";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetSyncStatus(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetSyncStatus(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<EmailSyncStatusResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<EmailSyncStatusResponse>;
        }));
    }

    protected processGetSyncStatus(response: HttpResponseBase): Observable<EmailSyncStatusResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = EmailSyncStatusResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    getSyncJobs(): Observable<SyncJobResponse[]> {
        let url_ = this.baseUrl + "/api/MailIntegration/GetSyncJobs";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetSyncJobs(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetSyncJobs(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<SyncJobResponse[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<SyncJobResponse[]>;
        }));
    }

    protected processGetSyncJobs(response: HttpResponseBase): Observable<SyncJobResponse[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(SyncJobResponse.fromJS(item));
            }
            else {
                result200 = null as any;
            }
...
export class EmailSyncStatusResponse implements IEmailSyncStatusResponse {
    hasFailedSync!: boolean;

    constructor(data?: IEmailSyncStatusResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.hasFailedSync = _data["hasFailedSync"];
        }
    }

    static fromJS(data: any): EmailSyncStatusResponse {
        data = typeof data === 'object' ? data : {};
        let result = new EmailSyncStatusResponse();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["hasFailedSync"] = this.hasFailedSync;
        return data;
    }
}

export interface IEmailSyncStatusResponse {
    hasFailedSync: boolean;
}

export class SyncJobResponse implements ISyncJobResponse {
    id!: number;
    accountEmail!: string;
    startedAt!: Date;
    finishedAt!: Date;
    ...
    constructor(data?: ISyncJobResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.importedEmailCount = _data["importedEmailCount"];
            this.errorMessage = _data["errorMessage"];
        }
    }

    static fromJS(data: any): SyncJobResponse {
        data = typeof data === 'object' ? data : {};
        let result = new SyncJobResponse();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["importedEmailCount"] = this.importedEmailCount;
