...
import {EditSimulationComponent} from "./simulation/edit-simulation/edit-simulation.component";
...
export const routes: Routes = [
    ...
    { path: 'simulation', component: SimulationComponent, title: 'MoneySpot - Simulation' },
    { path: 'simulation/new', component: EditSimulationComponent, title: 'MoneySpot - Neue Simulation' },
    { path: 'simulation/:id', component: EditSimulationComponent, title: 'MoneySpot - Simulation bearbeiten' },
];
