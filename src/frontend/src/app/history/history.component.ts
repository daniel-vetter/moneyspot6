...
export class HistoryComponent implements OnInit {
  ...
  async update() {
    ...
    const result = await lastValueFrom(this.accountHistoryClient.get([1, 2, 3], this.dateRange[0].toISOString().substring(0, 10), this.dateRange[1].toISOString().substring(0, 10)));
